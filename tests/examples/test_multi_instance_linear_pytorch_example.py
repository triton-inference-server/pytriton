...
LOGGER = logging.getLogger("tests.examples.test_multi_instance_linear_pytorch_example")
...
def main():
    ...
    verify_docker_image_in_readme_same_as_tested(
        "examples/multi_instance_linear_pytorch/README.md", docker_image_with_name
    )
    ...
    server_cmd = ["python", "examples/multi_instance_linear_pytorch/server.py"]
    client_cmd = ["python", "examples/multi_instance_linear_pytorch/client.py"]
