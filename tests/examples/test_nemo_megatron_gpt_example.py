...
from tests.utils import DEFAULT_LOG_FORMAT, ScriptThread  # pytype: disable=import-error

LOGGER = logging.getLogger("tests.examples.test_nemo_megatron_gpt_multinode_example")
