...
LOGGER = logging.getLogger("tests.examples.test_huggingface_bart_pytorch_example")
...
def main():
    ...
    server_cmd = ["python", "examples/huggingface_bart_pytorch/server.py"]
    client_cmd = ["python", "examples/huggingface_bart_pytorch/client.py"]
