...
"""Test of huggingface_dialogpt_streaming_pytorch example"""
import argparse
import logging
import re
import signal
...
def main():
    ...
    verify_docker_image_in_readme_same_as_tested(
        "examples/huggingface_dialogpt_streaming_pytorch/README.md", docker_image_with_name
    )

    install_cmd = ["bash", "examples/huggingface_dialogpt_streaming_pytorch/install.sh"]
    ...
    server_cmd = [
        "python",
        "examples/huggingface_dialogpt_streaming_pytorch/server.py",
        "--model-name",
        "microsoft/dialoGPT-small",
    ]
    client_cmd = [
        "python",
        "examples/huggingface_dialogpt_streaming_pytorch/client.py",
        "--model-name",
        "dialoGPT-small",
    ]
