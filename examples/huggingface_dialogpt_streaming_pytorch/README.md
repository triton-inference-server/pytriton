...
```shell
docker run -it --gpus 1 --shm-size 8gb -v {repository_path}:{repository_path} -w {repository_path} nvcr.io/nvidia/pytorch:23.08-py3 bash
```
...
export FROM_IMAGE_NAME=nvcr.io/nvidia/pytorch:23.08-py3
